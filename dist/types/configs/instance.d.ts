export declare type InstanceType = "virtual-machine" | "container";
export declare type InstancePowerState = "start" | "stop" | "restart" | "freeze";
export declare type InstanceStatus = "Stopped" | "Running";
